...
export const metadata: Metadata = {
  ...
  description:
    "Profesionalno odgušenje kanalizacije Savski venac 24/7. Hitne intervencije, povoljne cene, brz dolazak. Pokrivamo ceo Savski venac. Pozovite odmah!",
  keywords:
...
export default function OdgusenjeSavskiVenac() {
  const structuredData = {
    ...
    areaServed: {
      "@type": "Place",
      name: "Savski venac, Beograd",
    },
    openingHours: "Mo-Su 00:00-24:00",
    priceRange: "$$",
  }

  const savskiVenacNeighborhoods = [
    "Centar Savskog venca",
    "Dedinje",
    "Senjak",
    "Topčider",
    "Lisičji potok",
  ...
  const advantages = [
    ...
    "Dolazak za 30–45 minuta na bilo koju lokaciju u Savskom vencu",
      ...
      <div className="container mx-auto px-4 py-12 pt-17">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-blue-900">
            Odgušenje kanalizacije Savski venac – Hitne intervencije dostupne 0–24h
          </h1>
          <h2 className="text-xl md:text-2xl text-blue-800 mb-6">
            Pouzdana i brza pomoć kod svih vrsta zapušenja na teritoriji Savskog venca
          </h2>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto mb-8">
            ...
            kanalizacije u Savskom vencu spremna je da reaguje odmah, bilo da se nalazite u centru Savskog venca,
            Dedinjem, Senjaku, Topčideru, Lisičjem potoku ili kod Careve ćuprije.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          ...
          <div className="relative h-[300px] rounded-lg overflow-hidden">
            <Image
              ...
              alt="Odgušenje kanalizacije Savski venac - profesionalne usluge"
              fill
        ...
        <div className="bg-red-50 p-8 rounded-lg mb-16">
          <h2 className="text-2xl font-bold mb-6 text-center text-red-800">
            Najčešći uzroci zapušenja kanalizacije u Savskom vencu
          </h2>
          <p className="text-center mb-8 text-gray-700">
            Zbog starije kanalizacione infrastrukture u mnogim delovima Savskog venca i gustine naseljenosti, zapušenja
            su česta pojava. Neki od najčešćih uzroka su:
          </p>
        ...
        <div className="bg-blue-50 p-8 rounded-lg mb-16">
          <h2 className="text-2xl font-bold mb-6 text-center text-blue-800">
            Odgušenje kanalizacije Savski venac – Zašto izabrati nas?
          </h2>
          <p className="text-center mb-8 text-gray-700 max-w-3xl mx-auto">
            ...
            fokusom na Savski venac, gde smo intervenisali na hiljadama adresa. Naš cilj je brzo, temeljno i trajno
            rešenje svakog problema.
          </p>
        ...
        {/* Coverage areas */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold mb-8 text-center text-blue-800">Pokrivamo sve delove Savskog venca</h2>
          <p className="text-center mb-8 text-gray-700">Bez obzira da li se nalazite u:</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {savskiVenacNeighborhoods.map((neighborhood, index) => (
        ...
        {/* Map Section */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold mb-8 text-center text-blue-800">Lokacija - Savski venac</h2>
          <div className="rounded-lg overflow-hidden h-[400px] relative">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11384.123456789!2d20.4354321!3d44.7912345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475a7a987654321%3A0x987654321abcdef!2sSavski%20Venac%2C%20Belgrade%2C%20Serbia!5e0!3m2!1sen!2sus!4v1654789542873!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Mapa Savskog venca - Odgušenje kanalizacije"
            ></iframe>
          </div>
        </div>
        ...
        <div className="bg-blue-800 text-white p-8 rounded-lg mb-16">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">
              📞 Pozovite odmah za hitno odgušenje kanalizacije u Savskom vencu
            </h2>
