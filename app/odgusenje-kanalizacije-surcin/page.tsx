...
export const metadata: Metadata = {
  ...
  description:
    "Profesionalno odgušenje kanalizacije Surčin 24/7. Hitne intervencije, povoljne cene, brz dolazak. Pokrivamo ceo Surčin. Pozovite odmah!",
  keywords:
...
export default function OdgusenjeSurcin() {
  ...
  const advantages = [
    ...
    "Dolazak za 30–45 minuta na bilo koju lokaciju u Surčinu",
      ...
      <div className="container mx-auto px-4 py-12 pt-17">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-blue-900">
            Odgušenje kanalizacije Surčin – Hitne intervencije dostupne 0–24h
          </h1>
          <h2 className="text-xl md:text-2xl text-blue-800 mb-6">
            Pouzdana i brza pomoć kod svih vrsta zapušenja na teritoriji Surčina
          </h2>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto mb-8">
            ...
            kanalizacije u Surčinu spremna je da reaguje odmah, bilo da se nalazite u centru Surčina, Bečmenu,
            Dobanovcima, Jakovu, Petrovčiću, Boljevcima ili Progaru.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
          ...
          <div className="relative h-[300px] rounded-lg overflow-hidden">
            <Image
              ...
              alt="Odgušenje kanalizacije Surčin - profesionalne usluge"
              fill
        ...
        <div className="bg-red-50 p-8 rounded-lg mb-16">
          <h2 className="text-2xl font-bold mb-6 text-center text-red-800">
            Najčešći uzroci zapušenja kanalizacije u Surčinu
          </h2>
          <p className="text-center mb-8 text-gray-700">
            Zbog starije kanalizacione infrastrukture u mnogim delovima Surčina i gustine naseljenosti, zapušenja su
        ...
        <div className="bg-blue-50 p-8 rounded-lg mb-16">
          <h2 className="text-2xl font-bold mb-6 text-center text-blue-800">
            Odgušenje kanalizacije Surčin – Zašto izabrati nas?
          </h2>
          <p className="text-center mb-8 text-gray-700 max-w-3xl mx-auto">
            ...
            fokusom na Surčin, gde smo intervenisali na hiljadama adresa. Naš cilj je brzo, temeljno i trajno rešenje
            svakog problema.
          </p>
        ...
        {/* Coverage areas */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold mb-8 text-center text-blue-800">Pokrivamo sve delove Surčina</h2>
          <p className="text-center mb-8 text-gray-700">Bez obzira da li se nalazite u:</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {surcinNeighborhoods.map((neighborhood, index) => (
        ...
        <div className="bg-blue-800 text-white p-8 rounded-lg mb-16">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold mb-4">📞 Pozovite odmah za hitno odgušenje kanalizacije u Surčinu</h2>
